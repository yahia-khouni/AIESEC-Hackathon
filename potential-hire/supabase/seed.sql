...
BEGIN
    ...
    VALUES 
    (c1, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'alex.' || run_id || '@example.com', crypt('password123', gen_salt('bf')), NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"Alex Developer","role":"candidate"}', NOW(), NOW()),
    (c2, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'sarah.' || run_id || '@example.com', crypt('password123', gen_salt('bf')), NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"Sarah UI/UX","role":"candidate"}', NOW(), NOW()),
    (c3, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'michael.' || run_id || '@example.com', crypt('password123', gen_salt('bf')), NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"Michael Data","role":"candidate"}', NOW(), NOW()),
    (c4, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'emily.' || run_id || '@example.com', crypt('password123', gen_salt('bf')), NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"Emily DevOps","role":"candidate"}', NOW(), NOW()),
    (c5, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'david.' || run_id || '@example.com', crypt('password123', gen_salt('bf')), NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"David Backend","role":"candidate"}', NOW(), NOW()),
    (c6, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'jessica.' || run_id || '@example.com', crypt('password123', gen_salt('bf')), NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"Jessica Marketing","role":"candidate"}', NOW(), NOW()),
    (c7, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'ryan.' || run_id || '@example.com', crypt('password123', gen_salt('bf')), NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"Ryan Frontend","role":"candidate"}', NOW(), NOW()),
    (c8, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'olivia.' || run_id || '@example.com', crypt('password123', gen_salt('bf')), NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"Olivia Analyst","role":"candidate"}', NOW(), NOW()),
    (c9, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'daniel.' || run_id || '@example.com', crypt('password123', gen_salt('bf')), NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"Daniel Systems","role":"candidate"}', NOW(), NOW()),
    (c10, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'sophia.' || run_id || '@example.com', crypt('password123', gen_salt('bf')), NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"Sophia PM","role":"candidate"}', NOW(), NOW()),
    
    (e1, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'hiring.' || run_id || '@techcorp.com', crypt('password123', gen_salt('bf')), NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"TechCorp HR","role":"employer"}', NOW(), NOW()),
    (e2, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'talent.' || run_id || '@innovatestudios.com', crypt('password123', gen_salt('bf')), NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"Innovate Studios","role":"employer"}', NOW(), NOW()),
    (e3, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'careers.' || run_id || '@dataflow.io', crypt('password123', gen_salt('bf')), NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"DataFlow Inc","role":"employer"}', NOW(), NOW()),
    
    (inst1, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'admin.' || run_id || '@bootcamp.edu', crypt('password123', gen_salt('bf')), NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"Bootcamp Admin","role":"institution"}', NOW(), NOW());
